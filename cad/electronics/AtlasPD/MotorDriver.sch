...
U 1 1 6125E0E9
P 7900 1950
F 0 "J301" H 7980 1942 50  0000 L CNN
...
U 1 1 6125FD45
P 7300 1950
F 0 "#PWR0307" H 7300 1800 50  0001 C CNN
...
U 1 1 612604AA
P 7300 2050
F 0 "#PWR0308" H 7300 1800 50  0001 C CNN
...
U 1 1 6127A362
P 7900 2800
F 0 "J302" H 7980 2792 50  0000 L CNN
...
U 1 1 6127A3C2
P 7300 2800
F 0 "#PWR0309" H 7300 2650 50  0001 C CNN
...
U 1 1 6127A3CC
P 7300 2900
F 0 "#PWR0310" H 7300 2650 50  0001 C CNN
...
PWM_B
$Comp
L Driver_Motor:DRV8837C U303
U 1 1 61623F54
P 4650 3100
F 0 "U303" H 4900 2650 50  0000 C CNN
F 1 "DRV8837C" H 4900 2550 50  0000 C CNN
...
F 4 "C191000" H 4650 3100 50  0001 C CNN "LCSC Part #"
F 5 "C191000" H 4650 3100 50  0001 C CNN "LCSC"
	1    4650 3100
	1    0    0    -1  
$EndComp
$Comp
L Driver_Motor:DRV8837C U302
U 1 1 6162467C
P 4650 1400
F 0 "U302" H 4900 950 50  0000 C CNN
F 1 "DRV8837C" H 4900 850 50  0000 C CNN
...
F 4 "C191000" H 4650 1400 50  0001 C CNN "LCSC Part #"
F 5 "C191000" H 4650 1400 50  0001 C CNN "LCSC"
	1    4650 1400
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61640DB0
P 3100 1500
F 0 "U301" H 3100 1825 50  0000 C CNN
...
F 4 "C5593" H 3100 1500 50  0001 C CNN "LCSC Part #"
F 5 "C5593" H 3100 1500 50  0001 C CNN "LCSC"
	1    3100 1500
	1    0    0    -1  
$EndComp
$Comp
...
U 2 1 616444B9
P 3100 1950
F 0 "U301" H 3100 2275 50  0000 C CNN
...
F 4 "C5593" H 3100 1950 50  0001 C CNN "LCSC Part #"
F 5 "C5593" H 3100 1950 50  0001 C CNN "LCSC"
	2    3100 1950
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 616454A9
P 3100 2350
F 0 "U301" H 3100 2675 50  0000 C CNN
...
F 4 "C5593" H 3100 2350 50  0001 C CNN "LCSC Part #"
F 5 "C5593" H 3100 2350 50  0001 C CNN "LCSC"
	3    3100 2350
	1    0    0    -1  
$EndComp
$Comp
...
U 4 1 61646528
P 3100 2750
F 0 "U301" H 3100 3075 50  0000 C CNN
...
F 4 "C5593" H 3100 2750 50  0001 C CNN "LCSC Part #"
F 5 "C5593" H 3100 2750 50  0001 C CNN "LCSC"
	4    3100 2750
	1    0    0    -1  
$EndComp
$Comp
...
U 5 1 61647348
P 1100 2200
F 0 "U301" H 1330 2246 50  0000 L CNN
...
F 4 "C5593" H 1100 2200 50  0001 C CNN "LCSC Part #"
F 5 "C5593" H 1100 2200 50  0001 C CNN "LCSC"
	5    1100 2200
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 61660824
P 1100 2850
F 0 "#PWR0302" H 1100 2600 50  0001 C CNN
...
U 1 1 6163AB7D
P 4000 700
F 0 "#PWR0303" H 4000 550 50  0001 C CNN
...
U 1 1 6163C3B1
P 4250 700
F 0 "#PWR0304" H 4250 550 50  0001 C CNN
...
U 1 1 616C1A28
P 4650 3600
F 0 "#PWR0306" H 4650 3350 50  0001 C CNN
...
U 1 1 616C2741
P 4650 1900
F 0 "#PWR0305" H 4650 1650 50  0001 C CNN
