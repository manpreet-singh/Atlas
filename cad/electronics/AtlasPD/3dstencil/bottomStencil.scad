// Generated by SolidPython 1.1.3 on 2022-04-20 12:17:35
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.8000000000) {
					offset(r = 2.0000000000) {
						import(file = "C:/Users/v-singhmanp/git/Atlas/cad/electronics/AtlasPD/3dstencil/5V Buck Converter-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 2.0000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "C:/Users/v-singhmanp/git/Atlas/cad/electronics/AtlasPD/3dstencil/5V Buck Converter-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
