// Generated by SolidPython 1.1.3 on 2022-04-20 12:17:36
$fa = 0.4; $fs = 0.4;
...
rotate(a = 180, v = [1, 0, 0]) {
	difference() {
		...
		linear_extrude(center = true, height = 2.0000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "C:/Users/v-singhmanp/git/Atlas/cad/electronics/AtlasPD/3dstencil/5V Buck Converter-PasteTop.dxf", origin = [0, 0]);
			}
		}
	}
}
